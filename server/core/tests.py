...
class ProvisionScriptTests(TestCase):
    ...
    def test_script_removed_role(self):
        ...
        script = generate_provision_script(self.sg)
        self.assertIn("revoke_user", script)
    ...
    def test_empty_server_group(self):
        ...
        self.assertNotIn("revoke_user", desired_section)
        self.assertNotIn("delete_user", desired_section)
    ...
    def test_cleanup_section_lists_known_users(self):
        ...
        self.assertIn("delete_user", script)
    ...
    def test_cleanup_includes_removed_role_in_known(self):
        ...
        revoke_user call handles them; cleanup should not double-process)."""
        charlie = Member.objects.create(username="charlie", workspace=self.ws)
    ...
    def test_script_rename_helpers_present(self):
        script = generate_provision_script(self.sg)
        self.assertIn("revoke_user()", script)
        self.assertIn("delete_user()", script)
    ...
    def test_removed_user_gets_supplemental_group_removal(self):
        ...
        script = generate_provision_script(self.sg)
        self.assertIn("revoke_user charlie", script)
